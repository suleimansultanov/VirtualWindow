...
{
    public class FutureDateAttributeAdapter : GenericAttirbuteAdapter<FutureDateAttribute>
    {
        ...
        public override void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-futuredate", GetErrorMessage(context));
        }
